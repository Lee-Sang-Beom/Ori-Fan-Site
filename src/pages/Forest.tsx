      ...
      <div className={styles.site_wrap}>
        ...
        <section data-scroll className={styles.content}>
          <Section_content
            imgsrc={wind}
            title="바람의 원소"
            text="버려진 유적에 들어온 Ori는 빛의 그릇을 들고 폐허의 중심으로 이동하기 시작합니다.
             구모 또한 Ori의 뒤를 따라 버려진 유적 안으로 이동하게 되고,

             Ori가 빛의 그릇을 폐허의 중심 위치에 놓으면서 유적이 재가동됨과 함께 바람의 원소가 힘을 되찾게 됩니다.
             하지만 Ori를 위하여 무언가를 행동으로 옮기기로 결심한 구모에 의해, 유적은 갑자기 붕괴되기 시작합니다."
          />
        </section>
