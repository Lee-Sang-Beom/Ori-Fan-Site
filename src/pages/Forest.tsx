      ...
      <div className={styles.site_wrap}>
        ...
        <section data-scroll className={styles.content}>
          <SectionContent
            imgsrc={meetShine}
            title="잃어버린 빛"
            text="정령 나무의 마지막 빛으로 깨어난 Ori는 정령 나무가 잃어버린 힘의 원천 '사인'을 만납니다. 
            사인을 통해 Ori는 기능을 멈춘 니벨(Nibel)숲의 원소 3개를 다시 가동시켜 숲을 되살릴 수 있음을 알게 됩니다."
          />
        </section>
        ...
        <section data-scroll className={styles.content}>
          <SectionContent
            ...
            text="버려진 유적에 들어온 Ori는 빛의 그릇을 들고 유적의 중심으로 이동하기 시작하고,
             ...
             하지만 Ori와 사인의 이야기를 듣던 구모는 Ori를 위하여 무언가를 행동으로 옮기기로 결심하게 되고, 그 여파로 유적은 갑자기 붕괴되기 시작합니다."
          />
        </section>
        ...
        <section data-scroll className={styles.content}>
          <SectionContent
            ...
            Ori는 불의 원소가 있는 공간의 입구를 막고 있는 용암의 높이를 낮추기 위해, 사인과 함께 용암이 흐르는 여덟 곳의 공간을 바위로 막아버립니다."
          />
        </section>
